...
namespace Stratiteq.Microservices.ClientCertAuth
{
    ...
    {
        /// <summary>
        /// Gets or sets a delegate that will be invoked when the authentication fails.
        /// </summary>
        public Func<CertificateAuthenticationFailedContext, Task> OnAuthenticationFailed { get; set; } = context => Task.CompletedTask;

        /// <summary>
        /// Gets or sets a delegate that will be invoked when a certificate has passed basic validation, but where custom validation may be needed.
        /// </summary>
        /// <remarks>
