...
namespace Stratiteq.Microservices.ClientCertAuth
{
    public class CertificateAuthenticationOptions : AuthenticationSchemeOptions
    {
        ...
        /// <summary>
        /// Gets or sets a value that specifies which X509 certificates in the chain should be checked for revocation.
        /// </summary>
        public X509RevocationFlag RevocationFlag { get; set; } = X509RevocationFlag.ExcludeRoot;

        /// <summary>
        /// Gets or sets a value that specifies conditions under which verification of certificates in the X509 chain should be conducted.
        /// </summary>
        public X509RevocationMode RevocationMode { get; set; } = X509RevocationMode.Online;

        /// <summary>
        /// Gets or sets the object provided by the application to process events raised by the certificate authentication middleware.
